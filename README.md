...
#### مرحله تولید کلیدواژه
در این مرحله برای کنترل هزینه و پایداری سیستم:

- تعداد توکن‌های خروجی AI محدود شده است
-  فاکتورهای timeout و retry برای درخواست‌های AI پیاده‌سازی شده‌اند
- در صورت عدم دسترسی به AI، سیستم به‌صورت خودکار از کلمات کلیدی fallback استفاده می‌کند

#### مرحله اعتبارسنجی
در این مرحله، از یک رویکرد ترکیبی استفاده شده است:
- فیلتر rule-based سریع برای حذف کانال‌های واضحاً غیرمرتبط
- اعتبارسنجی معنایی با استفاده از مدل زبانی (AI) برای تصمیم‌گیری دقیق‌تر

در صورت عدم دسترسی به AI، سیستم به‌صورت امن به حالت fallback بازمی‌گردد.
